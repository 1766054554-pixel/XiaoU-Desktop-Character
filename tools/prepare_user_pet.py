"""
本模块将用户私有的八姿态透明图集转换为桌面角色运行所需的 38 帧素材。
...
from xiaou_desktop.workflow import WorkflowError, require_character_approved
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="从八姿态图集生成私有桌面角色素材")
...
def main() -> int:
    ...
    print(f"已生成 {frame_count} 个私有桌面角色帧：{output_root}")
